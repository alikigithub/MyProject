const IMAGES = {
  ...
  googleImg: require('../images/googleLogo.png'),
  backImg: require('../images/backArrow.png'),
  ...
  user2: require('../images/userProfile2.png'),
  user: require('../images/userProfile1.png'),
  edit: require('../images/editSign.png'),
};
